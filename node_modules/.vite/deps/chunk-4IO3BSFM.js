...
var _n = (r, e, t, n) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of to(e)) !no.call(r, i) && i !== t && Ie(r, i, { get: () => e[i], enumerable: !(n = eo(e, i)) || n.enumerable });
  return r;
};
...
function $o(r) {
  if (r === "sha256") return { update: function(e) {
    return { digest: function() {
      return d.from($e(e));
    } };
  } };
  if (r === "md5") return { update: function(e) {
    return { digest: function() {
...
var vs = I((qe) => {
  ...
  var M = zr(), ic = ws(), sc = nc((Ss(), k(bs))), rn = 1, oc = 4, xs = rn + oc, Es = d.allocUnsafe(
    ...
    constructor(e) {
      if (this.buffer = Es, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ic.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-4IO3BSFM.js.map
